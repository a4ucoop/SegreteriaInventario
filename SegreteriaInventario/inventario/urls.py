...
urlpatterns = [
    ...
    url(r'^ricinv/createNoLabel$', views.ricognizioneInventarialeCreateNoLabelView,name='ricinv_add_no_label'),
	url(r'^ricinv/edit/', views.ricognizioneInventarialeEditView,name='ricinv_edit'),
    url(r'^ricinv/editNoLabel/', views.ricognizioneInventarialeEditNoLabelView,name='ricinv_edit_no_label'),
    ...
    url(r'^update/codInvent', views.updateCodiciInventario, name='updateCodiciInventario'),
    url(r'^update/addCodInvent', views.addCodiceInventario, name='addCodiceInventario'),
