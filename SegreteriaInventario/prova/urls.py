...
urlpatterns = [
    ...
    url(r'^examples/bootstrap_table_editable/editAccurateLocation', views.editAccurateLocation, name='editAccurateLocation'),
    url(r'^examples/bootstrap_table_editable/getAccurateLocationList', views.getAccurateLocationList, name='getAccurateLocationList'),
    url(r'^examples/bootstrap_table_editable/addAccurateLocation', views.addAccurateLocation, name='addAccurateLocation'),  
